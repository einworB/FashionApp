...
/**
 * This activity shows the details of a certain outfit. The outfit itself is loaded by the
 * presenter.
 * An outfit consists of up to ten pieces, the top left (and the biggest) image represents the
 * currently selected piece. The selection can be changed by clicking on one of the smaller images.
 * When an image is loaded the event listener onImageLoaded gets called. Clicking the "i" menu
 * button causes the PieceDetailActivity to be opened for the selected piece.
 * Clicking the "share" menu button allows the user to share a screenshot of the outfit together
...
public class OutfitDetailActivity
  ...
  private ImageView mainPiece, pieceTwo, pieceThree, pieceFour, pieceFive, pieceSix, pieceSeven,
      pieceEight, pieceNine, pieceTen;
  ...
  private void setupImages() {
    ...
    mainPiece.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        ...
        startActivity(
            LinkService.getDetailIntent(OutfitDetailActivity.this, WardrobeFragment.TYPE_PIECE,
                null, wardrobeID, pieceID, getIntent().getExtras().getBoolean("isDetail")));
      }
    });
