 ...
 */
public class SettingsAdapter extends CBAdapterRecyclerView<WardrobeMenuWardrobeItem> implements
    TextWithIconViewHolder.TextWithIconViewHolderListener {
  ...
  public SettingsAdapter(Context context, SettingsAdapterListener listener) {
    ...
    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
      ...
      closeIcon =
          context.getResources().getDrawable(android.R.drawable.ic_menu_close_clear_cancel);
    }
    this.listener = listener;
  }

  // TODO: add getItemViewByType() and switch cases for different viewtypes if more than one viewtype is needed
  ...
  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    return new TextWithIconViewHolder(inflater.inflate(R.layout.simple_text_with_icon, parent, false));
  }
