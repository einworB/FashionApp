...
public class WardrobeActivity extends
    ...
    @NonNull
    @Override
    public WardrobeMenuPresenter createPresenter() {
        return new WardrobeMenuPresenter(this, this);
    }

    @Override
    public void setData(List<WardrobeMenuItem> data) {
    ...
    @Override
    protected WardrobePagerAdapter createAdapter() {
    ...
    @Override
    public void onWardrobeClicked(String ID, String title) {
    ...
    @Override
    public void onNewWardrobeClicked() {
        presenter.addNewWardrobe();
    }

    @Override
    public void onLinkClicked(String title) {
    ...
    private void handleMenuFilter() {
        ...
        String[] colors = {"no filter", "red", "blue", "green", "yellow", "black", "white", "pink", "purple", "orange", "turquoise"};

        final ArrayAdapter<String> season_adp = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, seasons);
        final ArrayAdapter<String> cat_adp = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, categories);
        final ArrayAdapter<String> occ_adp = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, occasions);
        final ArrayAdapter<String> col_adp = new ArrayAdapter<String>(this,
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        int[] itemPositions = new int[]{
                                sp_cat.getSelectedItemPosition(),
